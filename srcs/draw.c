...
/*   Updated: 2016/02/26 15:58:36 by acazuc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		draw_water(t_env *env, int x, int y)
{
	...
	i = 0;
	if (y < MAP_SIZE - 1 && x > 0 && env->map[y + 1][x - 1] + env->water[y + 1][x - 1] > env->map[y][x])
		i = env->map[y + 1][x - 1] + env->water[y + 1][x - 1] - env->map[y][x] - 1;
